...
export default function SearchTrigger({
  ...
  return (
    ...
    >
      ...
      <span
        className={
          "placeholder-text hidden text-sm text-gray-600 group-hover:text-gray-900 xl:inline-flex " + placeholderClassName
        }
      >
        Search your page...
      </span>
